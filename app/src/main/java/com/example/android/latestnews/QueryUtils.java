 ...
 *
 * Helper methods related to requesting and receiving earthquake data from the news website.
 */
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            for (int i = 0; i < newsArray.length(); i++) {
                ...
                // Create a new {@link News} object with the title, description and url
                // from the JSON response.
                News story = new News(title, description, url);
